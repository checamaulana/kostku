  ...
  return (
    <div className="bg-white brutalist-border brutalist-shadow transition-all hover:translate-x-1 hover:translate-y-1 cursor-pointer">
      ...
      <div className="p-6">
        ...
        <button className="w-full bg-midnight-blue text-white py-3 font-bold text-lg uppercase brutalist-border brutalist-shadow transition-all hover:translate-x-1 hover:translate-y-1">
          LIHAT DETAIL
        </button>
      </div>
    </div>
